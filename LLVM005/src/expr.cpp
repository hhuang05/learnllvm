/*
 * Generates instructions given an IR builder and a context
 * The IRBuilder contains the API necessary to generate correct instructions
 */
#include "expr.h"
...
llvm::Value* AddExpr::gen(llvm::IRBuilder<> *builder,
		llvm::LLVMContext &context) const {
...
llvm::Value* MulExpr::gen(llvm::IRBuilder<> *builder,
		llvm::LLVMContext &context) const {
	llvm::Value* v1 = op1->gen(builder, context);
	llvm::Value* v2 = op2->gen(builder, context);
